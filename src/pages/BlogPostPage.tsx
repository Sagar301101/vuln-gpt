    ...
    return (
      <Section py={{ base: "80px", md: "120px" }}>
        <Box textAlign="center">
          ...
          <Button as={RouterLink} to="/blog" variant="outlineSubtle" leftIcon={<ArrowLeft size={16} />}>
            Back to blog
          </Button>
        </Box>
      </Section>
  ...
  return (
    <>
      <Section innerMaxW="760px" py={{ base: "40px", md: "64px" }} pb={{ base: "16px", md: "24px" }}>
        <Link as={RouterLink} to="/blog" color="wa.55" fontSize="14px" display="inline-flex" alignItems="center" gap="6px" mb="24px" _hover={{ color: "white" }}>
